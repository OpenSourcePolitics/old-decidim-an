document.addEventListener("DOMContentLoaded",function() {
  ...
  $('.progress__bar').each(function() {
    ...
    if (nombre_signatures_int >= seuil_1_int) {
      ...
      $(this).html(jQuery(this).html().replaceAll(progress_bar_value_seuil_1 + " percent", progress_bar_value_seuil_2 + " percent").replaceAll(progress_bar_value_seuil_1 + "%", progress_bar_value_seuil_2 + "%"));
    }
  });
});
